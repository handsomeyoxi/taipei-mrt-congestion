...
# 文湖線（棕線）BR - 23個站點
BR_STATIONS = ['動物園', '木柵', '萬芳社區', '萬芳醫院', '辛亥', '麟光', '六張犁', '科技大樓', '大安', '南京復興', '中山國中', '松山機場', '忠孝復興', '大直', '劍南路', '西湖', '港墘', '文德', '內湖', '大湖公園', '葫洲', '東湖', '南港軟體園區', '南港展覽館']

# 淡水信義線（紅線）R - 28個站點
R_STATIONS = ['淡水', '紅樹林', '竹圍', '關渡', '忠義', '復興崗', '北投', '新北投', '奇岩', '唭哩岸', '石牌', '明德', '芝山', '士林', '劍潭', '圓山', '民權西路', '中山', '雙連', '台北車站', '台大醫院', '中正紀念堂', '東門', '大安森林公園', '大安', '信義安和', '台北101/世貿', '象山']

# 松山新店線（綠線）G - 19個站點
G_STATIONS = ['松山', '南京三民', '台北小巨蛋', '南京復興', '中山', '松江南京', '北門', '西門', '中正紀念堂', '古亭', '台電大樓', '公館', '萬隆', '景美', '大坪林', '七張', '小碧潭', '新店區公所', '新店']

# 中和新蘆線（橘線）O - 26個站點
O_STATIONS = ['南勢角', '頂溪', '永安市場', '景安', '古亭', '東門', '忠孝新生', '松江南京', '行天宮', '中山國小', '大橋頭', '台北橋', '菜寮', '三重', '先嗇宮', '頭前庄', '新莊', '輔大', '丹鳳', '迴龍', '三重國小', '三和國中', '徐匯中學', '三民高中', '蘆洲', '民權西路']

# 板南線（藍線）BL - 22個站點
BL_STATIONS = ['頂埔', '永寧', '土城', '海山', '亞東醫院', '府中', '板橋', '江子翠', '龍山寺', '西門', '善導寺', '忠孝新生', '忠孝復興', '忠孝敦化', '國父紀念館', '市政府', '永春', '後山埤', '昆陽', '南港', '南港展覽館', '台北車站', '新埔']

# 環狀線（黃線）Y - 14個通車站點（2024年1月31日第一期開通）
Y_STATIONS = ['新北產業園區', '幸福', '板新', '中原', '板橋', '新埔', '大坪林', '十四張', '秀朗橋', '景平', '景安', '中和', '橋和', '頭前庄']
