...
# 松山新店線（綠線）G - 17個站點（已移除不屬於綠線的善導寺和忠孝新生）
G_STATIONS = ['松山', '南京三民', '台北小巨蛋', '南京復興', '台北車站',
              '小南門', '中正紀念堂', '古亭', '台電大樓', '公館', '萬隆', '景美', '大坪林',
              '七張', '新店區公所', '新店', '小碧潭']

# 中和新蘆線（橘線）O - 25個站點（已移除不屬於橘線的新埔）
O_STATIONS = ['迴龍', '丹鳳', '輔大', '新莊', '頭前庄', '先嗇宮', '三重國小',
              '三和國中', '蘆洲', '大橋頭', '台北橋', '菜寮', '三重', '新埔民生', '中山國小',
              '行天宮', '松江南京', '忠孝新生', '民權西路', '東門', '古亭', '頂溪', '景安', '中和', '南勢角']
...
Y_STATIONS = ['大坪林', '十四張', '秀朗橋', '景平', '景安', '中和', '橋和', '永安市場',
              '中原', '板新', '板橋', '新埔', '幸福', '新北產業園區']
