...
# 文湖線（棕線）BR - 23個站點
BR_STATIONS = ['動物園', '木柵', '萬芳社區', '萬芳醫院', '辛亥', '麟光', '六張犁', '科技大樓', '大安', '南京復興', '中山國中', '松山機場', '大直', '劍南路', '西湖', '港墘', '文德', '內湖', '大湖公園', '葫洲', '東湖', '南港軟體園區', '南港展覽館']

# 淡水信義線（紅線）R - 28個站點
R_STATIONS = ['淡水', '紅樹林', '竹圍', '關渡', '忠義', '復興崗', '北投', '新北投', '奇岩', '唭哩岸', '石牌', '明德', '芝山', '士林', '劍潭', '圓山', '民權西路', '中山', '雙連', '台北車站', '台大醫院', '中正紀念堂', '東門', '大安森林公園', '大安', '信義安和', '台北101/世貿', '象山']

# 松山新店線（綠線）G - 18個站點
G_STATIONS = ['松山', '南京三民', '台北小巨蛋', '南京復興', '北門', '西門', '中正紀念堂', '古亭', '台電大樓', '公館', '萬隆', '景美', '大坪林', '七張', '小碧潭', '新店區公所', '新店', '大安']
